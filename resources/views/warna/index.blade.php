...
<body>
    <div class="container">
        <div class="card text-sm-center" style="margin-left: 47rem; margin-right:15rem;">
            <a href="{{ route('warna.create') }}" class="btn btn-sm btn-outline-success" style="float: right">
